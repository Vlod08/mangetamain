...
def kde_with_range(df, column, value_range, color="#1f77b4"):
    ...
    fig.add_vrect(x0=x.min(), x1=value_range[0], fillcolor="gray", opacity=0.25, line_width=0)
    fig.add_vrect(x0=value_range[1], x1=x.max(), fillcolor="gray", opacity=0.25, line_width=0)
